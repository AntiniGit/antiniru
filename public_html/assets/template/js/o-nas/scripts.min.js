...
$(function() {
  ...
  if (window.innerWidth>=768) {
	  $('.section-tabs__nav').scrollTabs();
  }

  $('.section-tabs__nav li').on('click', function(event) {
    event.preventDefault();
    var parent = $(this).closest('.section-tabs');
    parent.find('.section-tabs__nav li.active').removeClass('active');
    $(this).addClass('active');
    parent.find('.section-tabs__tabs li').hide();
    parent.find('.section-tabs__tabs li[data-tab=' + $(this).attr('data-tab') + ']').fadeIn(600);
  });
  ...
  $('.input_block input').each(function() {
    var _this = $(this);
    if (_this.val() == "") {
      _this.closest('.input_block').removeClass('hasData')
    } else {
      _this.closest('.input_block').addClass('hasData')
    }
  })

  $('.input_block input').on("input", function() {
    var _this = $(this);
    if (_this.val() == "") {
      _this.closest('.input_block').removeClass('hasData')
    } else {
